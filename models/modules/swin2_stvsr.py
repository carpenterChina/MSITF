...
class Swin2SR(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
                 ...
                 use_checkpoint=False, upscale=2, resi_connection='1conv',
                 **kwargs):
...
if __name__ == '__main__':
    upscale = 4
    window_size = 4
    height = (128 // upscale // window_size) * window_size
    width = (128 // upscale // window_size) * window_size
    # model = Swin2SR(upscale=4, img_size=(height, width),
    #                window_size=window_size, img_range=1., depths=[4, 4, 4, 4],
    #                embed_dim=72, num_heads=[8, 8, 8, 8], mlp_ratio=2, upsampler='pixelshuffledirect')

    model = Swin2SR(upscale=4, in_chans=72,
                    img_size=32, window_size=4,
                    depths=[4, 4, 4, 4], embed_dim=72,
                    num_heads=[6, 6, 6, 6],
    ...
    x = torch.randn((1, 72, height, width))
    print(x.shape)
    import time
