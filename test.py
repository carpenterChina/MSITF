...
def main():
    ...
    #### dataset
    data_mode = 'Vid4' #'Vid4' #'SPMC'#'Middlebury'#

    if data_mode == 'Vid4':
        test_dataset_folder = '/remote-home/cs_cs_lj/zhj/BasicSR/datasets/Vid4_matlab/matlab_BDx4/*'
    if data_mode == 'SPMC':
    ...
    for sub_folder in sub_folder_l:
        ...
        if data_mode == 'SPMC':
            ...
            sub_folder_GT = osp.join(sub_folder.replace('/matlab_BDx4/', '/GT/'))
